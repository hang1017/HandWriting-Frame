...
const grids = colors.map((color) => (
  <Grid.Item style={{ textAlign: "center" }} key={color}>
    <Space direction="vertical">
      <Image src={demoSrc} width={64} height={64} fit="cover" style={{ borderRadius: 4, background: color }} />
      <div
        style={{
